...
-/
theorem alive_AddSub_1043 : forall (w : Nat) (Z C1 RHS : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
...
-/
theorem alive_AddSub_1152: forall (x y : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
...
-/
theorem alive_AddSub_1176 : forall (w : Nat) (b a : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AddSub_1556: forall (x y : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AddSub_1574 : forall (w : Nat) (X C2 C : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AddSub_1614 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AddSub_1619 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_698 : forall (w : Nat) (a b d : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_709 : forall (w : Nat) (a b d : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_716 : forall (w : Nat) (a b d : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_794 : forall (w : Nat) (a b : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_827 : forall (w : Nat) (a b : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_887_2 : forall (w : Nat) (a C1 : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_1288_A__B__B__C__A___A__B__C : forall (w : Nat) (A B C : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_1683_1 : forall (w : Nat) (a b : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_1683_2 : forall (w : Nat) (a b : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_1704 : forall (w : Nat) (B A : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_1705 : forall (w : Nat) (B A : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_1733 : forall (w : Nat) (A B : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2123___A__B__A__B___A__B : forall (w : Nat) (B A : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2188 : forall (w : Nat) (D A : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2231__A__B__B__C__A___A__B__C : forall (w : Nat) (A B C : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2243__B__C__A__B___B__A__C : forall (w : Nat) (B C A : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2263 : forall (w : Nat) (op0 B : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2375 : forall (w : Nat) (x : Bitvec w )
(A B C D : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
...
-/
theorem alive_AndOrXor_2429 : forall (w : Nat) (x y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2430 : forall (w : Nat) (x y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2443 : forall (w : Nat) (x y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2453 : forall (w : Nat) (x y : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2475 : forall (w : Nat) (C x : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2658 : forall (w : Nat) (b a : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_AndOrXor_2663 : forall (w : Nat) (a b : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_160: forall (C1 : Bitvec 7 )
(x C2 : Bitvec 7 )
, TSSA.eval
  (Op := Op) (e := e)
...
-/
theorem alive_239 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_265 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_265_2 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_266 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_266_2 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_275: forall (X Y : Bitvec 5 )
, TSSA.eval
  (Op := Op) (e := e)
...
-/
theorem alive_275_2: forall (X Y : Bitvec 5 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 5)))
  [dsl_bb|
...
-/
theorem alive_276: forall (X Y : Bitvec 5 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 5)))
  [dsl_bb|
...
-/
theorem alive_276_2: forall (X Y : Bitvec 5 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 5)))
  [dsl_bb|
...
-/
theorem alive_283: forall (X Y : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
  [dsl_bb|
...
-/
theorem alive_SimplifyDivRemOfSelect : forall (w : Nat) (c : Bitvec w )
(Y X : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
...
-/
theorem alive_805 : forall (w : Nat) (X : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_891: forall (N : Bitvec 13 )
(x : Bitvec 13 )
, TSSA.eval
  (Op := Op) (e := e)
...
-/
theorem alive_891_exact: forall (N : Bitvec 13 )
(x : Bitvec 13 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 13)))
...
-/
theorem alive_1049: forall (X : Bitvec 11 )
(C : Bitvec 11 )
, TSSA.eval
  (Op := Op) (e := e)
...
-/
theorem alive_Select_485_2 : forall (w : Nat) (x : Bitvec w )
(A B : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
...
-/
theorem alive_Select_489_2 : forall (w : Nat) (x : Bitvec w )
(A B : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
...
-/
theorem alive_Select_637 : forall (w : Nat) (X C Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_641 : forall (w : Nat) (X C Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_699 : forall (w : Nat) (A B : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_700 : forall (w : Nat) (A B : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_704 : forall (w : Nat) (A B : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_705 : forall (w : Nat) (A B : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_740 : forall (w : Nat) (A : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_741 : forall (w : Nat) (A : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_746 : forall (w : Nat) (A : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_747 : forall (w : Nat) (A : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_846: forall (B : Bitvec 1 )
(C : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
...
-/
theorem alive_Select_850: forall (B : Bitvec 1 )
(C : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
...
-/
theorem alive_Select_855: forall (B : Bitvec 1 )
(C : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
...
-/
theorem alive_Select_859: forall (B : Bitvec 1 )
(C : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
...
-/
theorem alive_Select_851: forall (a : Bitvec 1 )
(b : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
...
-/
theorem alive_Select_852: forall (a : Bitvec 1 )
(b : Bitvec 1 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 1)))
...
-/
theorem alive_Select_858 : forall (w : Nat) (a b : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_859' : forall (w : Nat) (a b : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_962 : forall (w : Nat) (c : Bitvec w )
(x y z : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
...
-/
theorem alive_Select_967a: forall (x y : Bitvec 9 )
(c : Bitvec 9 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 9)))
...
-/
theorem alive_Select_967b: forall (x y : Bitvec 9 )
(c : Bitvec 9 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 9)))
...
-/
theorem alive_Select_1070 : forall (w : Nat) (c : Bitvec w )
(W Z Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
...
-/
theorem alive_Select_1078 : forall (w : Nat) (c : Bitvec w )
(W Z X : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
...
-/
theorem alive_Select_1087 : forall (w : Nat) (val X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_1100 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_Select_1105 : forall (w : Nat) (X Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_InstCombineShift__351: forall (C2 : Bitvec 7 )
(X C1 : Bitvec 7 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 7)))
...
-/
theorem alive_InstCombineShift__422_1: forall (Y : Bitvec 31 )
(X C : Bitvec 31 )
, TSSA.eval
  (Op := Op) (e := e)
...
-/
theorem alive_InstCombineShift__422_2: forall (Y : Bitvec 31 )
(X C : Bitvec 31 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 31)))
...
-/
theorem alive_InstCombineShift__440 : forall (w : Nat) (X C C2 Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_InstCombineShift__458: forall (Y : Bitvec 31 )
(X C : Bitvec 31 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 31)))
...
-/
theorem alive_InstCombineShift__476 : forall (w : Nat) (X C C2 Y : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_InstCombineShift__497 : forall (w : Nat) (X C2 C : Bitvec w )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
...
-/
theorem alive_InstCombineShift__724: forall (C2 : Bitvec 31 )
(C1 A : Bitvec 31 )
, TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec 31)))
