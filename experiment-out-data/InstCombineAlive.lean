...
-/
theorem alive_AddSub_1152 : forall (w : Nat) (x y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AddSub_1556 : forall (w : Nat) (x y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1230__A__B___A_|_B : forall (w : Nat) (notOp0 notOp1 : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1241_A|B__AB_=_A^B : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1247_AB__A|B_=_A^B : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1253_A__A^B___A__B : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1280_A|BA___AB : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1288_A_^_B__B_^_C_^_A___A_^_B__C : forall (w : Nat) (A B C : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1294_A_|_B__A_^_B___A__B : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_1704 : forall (w : Nat) (B A : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2063__X_^_C1_|_C2____X_|_C2_^_C1__C2 : forall (w : Nat) (x C1 C : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2113___A__B_|_A___A_|_B : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2118___A__B_|_A___A_|_B : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2123___A__B_|_A_^_B___A_^_B : forall (w : Nat) (B A : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2231__A_^_B_|_B_^_C_^_A___A_^_B_|_C : forall (w : Nat) (A B C : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2243__B_|_C__A_|_B___B_|_A__C : forall (w : Nat) (B C A : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2247__A_|_B_==_A__B : forall (w : Nat) (A B : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2453 : forall (w : Nat) (x y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2581__B|A^B___A__B : forall (w : Nat) (a op1 : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2587__BA^A___B__A : forall (w : Nat) (a op1 : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_AndOrXor_2663 : forall (w : Nat) (a b : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_160 : forall (w : Nat) (x C2 C1 : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_275 : forall (w : Nat) (X Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_275_2 : forall (w : Nat) (X Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_276 : forall (w : Nat) (X Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_276_2 : forall (w : Nat) (X Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_283 : forall (w : Nat) (X Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_820 : forall (w : Nat) (X Op1 : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_891 : forall (w : Nat) (N x : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_891_exact : forall (w : Nat) (N x : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_1049 : forall (w : Nat) (X C : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_Select_846 : forall (w : Nat) (B C : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_Select_967a : forall (w : Nat) (x y c : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_Select_967b : forall (w : Nat) (x y c : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_InstCombineShift__351 : forall (w : Nat) (X C1 C2 : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_InstCombineShift__422_1 : forall (w : Nat) (X C Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_InstCombineShift__422_2 : forall (w : Nat) (X C Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_InstCombineShift__458 : forall (w : Nat) (X C Y : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
...
-/
theorem alive_InstCombineShift__724 : forall (w : Nat) (C1 A C2 : Int), TSSA.eval
  (Op := Op) (e := e)
  (i := TSSAIndex.TERMINATOR (UserType.base (BaseType.bitvec w)))
  [dsl_bb|
  ^bb
