...
(*
 ...
 let %c2 = icmp sge %smin, %A in 
 let %smax = select i1 %c2, %smin, %A in 
...
*)
let alive_Select_704 (w : pos) (input_b input_a : BV.bv_t 1)
 : Lemma ((
  let var_0 = () in
  ...
  let var_8 = op_icmp sge  w var_7 in
  ...
  let var_6 = op_select 1 var_5 in
  let var_7 = (var_6, var_1) in
  let var_8 = op_icmp sge  1 var_7 in
