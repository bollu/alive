...
(* precondition: true *)
(*
 let %Op1 = lshr i31 %X, C in 
 let %Op0 = add %Y, %Op1 in 
 let %r = shl %Op0, C in 
...
let alive_InstCombineShift__422_1 (input_c input_x input_y : BV.bv_t 31)
 : Lemma ((
  ...
  let var_9 = op_lshr 31 var_8 in
  let var_10 = (var_1, var_9) in
  let var_11 = op_add 31 var_10 in
