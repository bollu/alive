...
*)
let alive_InstCombineShift__440 (w : pos) (input_c2 input_c input_x input_y : BV.bv_t w)
 : Lemma ((
  let var_0 = () in
  ...
  let var_3 = op_const (input_c) var_0 in
  let var_4 = (var_2, var_3) in
  let var_5 = op_shl w var_4 in
  let var_6 = (var_1, var_5) in
  let var_7 = op_and w var_6 in
  let var_8 = op_const (input_y) var_0 in
  let var_9 = (var_8, var_3) in
  let var_10 = op_shl w var_9 in
  let var_11 = (var_1, var_3) in
  let var_12 = op_lshr w var_11 in
  let var_13 = (var_12, var_2) in
  let var_14 = op_and w var_13 in
  let var_15 = (var_8, var_14) in
  let var_16 = op_xor w var_15 in
  let var_17 = (var_7, var_10) in
  let var_18 = op_xor w var_17 in
  (* return_value *) var_18))
 = ()