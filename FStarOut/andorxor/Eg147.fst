...
(* precondition: true *)
(*
 let %op0 = icmp slt %x, %y in 
 let %r = xor %op0, -1 in 

=>
 let %op0 = icmp slt %x, %y in 
 let %r = icmp sge %x, %y in 

*)
let alive_AndOrXor_2453 (w : pos) (input_x input_y : BV.bv_t w)
 : Lemma ((
  let var_0 = () in
  ...
  let var_6 = op_icmp sge  w var_5 in
  (* return_value *) var_6))
 = ()