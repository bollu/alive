...
(*
 let %a1 = and %a, %b in 
 let %a2 = and %a, %d in 
 let %op0 = icmp eq %a1, %b in 
 let %op1 = icmp eq %a2, %d in 
...
=>
 ...
 let %op0 = icmp eq %a1, %b in 
 let %op1 = icmp eq %a2, %d in 
 let %r = icmp eq %a3, %or in 

*)
let alive_AndOrXor_709 (w : pos) (input_d input_b input_a : BV.bv_t w)
 : Lemma ((
  let var_0 = () in
  ...
  let var_8 = (var_4, var_2) in
  let var_9 = op_icmp eq  w var_8 in
  let var_10 = (var_7, var_5) in
  ...
  let var_12 = (var_9, var_1) in
  let var_13 = op_icmp eq  w var_12 in
  let var_14 = (var_11, var_2) in
  let var_15 = op_icmp eq  w var_14 in
  let var_16 = (var_7, var_4) in
