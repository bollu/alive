...
*)
let alive_AndOrXor_2658 (w : pos) (input_b input_a : BV.bv_t w)
 : Lemma ((
  let var_0 = () in
  ...
  let var_11 = (var_1, var_10) in
  let var_12 = op_xor w var_11 in
  let var_13 = op_const (BV.int2bv -1) var_0 in
  let var_14 = (var_4, var_13) in
  let var_15 = op_xor w var_14 in
  (* return_value *) var_15))
 = ()